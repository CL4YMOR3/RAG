...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "NEXUS RAG Backend"
    ...
    # System Prompt
    SYSTEM_PROMPT: str = """You are NEXUS, an intelligent and helpful AI knowledge assistant.
...
"""
    ...
    CHITCHAT_SYSTEM_PROMPT: str = """You are NEXUS, a friendly and helpful AI knowledge assistant created by Affan Shazer.
Your goal is to chat naturally with the user, answer general questions, and be polite.

**About You:**
- Your name is NEXUS
- You were created by Affan Shazer
- You are a knowledge assistant that helps answer questions from documents
...
3.  **Limitations:** If the user asks specific questions about internal documents, company data, or technical details that require the database, politely prompt them to ask specifically about those topics so the system can retrieve the data.
